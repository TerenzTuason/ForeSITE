...
class AssessmentResultController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'result.individual_votes.decision_tree' => 'sometimes|string',
            'result.individual_votes.random_forest' => 'sometimes|string',
            'result.individual_votes.support_vector_machine' => 'sometimes|string',
            'result.individual_votes.logistic_regression' => 'sometimes|string',
            'result.individual_votes.cnn' => 'sometimes|string',
            'result.individual_votes.xgboost' => 'sometimes|string',
            'result.individual_votes.blending_ensemble' => 'sometimes|string',
